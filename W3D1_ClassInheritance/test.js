describe("Account",function(){
    it("new Account must have zero balance",function(){
        assert.equal(new Account("7248").getBalance(),0.0);
    });
});
describe("DepositToAccount",function(){
    it("must throw error if negative value provided",function(){
        let acc=new Account("234");
        assert.throw(()=>acc.deposit(-10), Error);
    });
    it("must deposit the right amount",function(){
        let acc = new Account("894");
        acc.deposit(10);
...
describe("End of Month Account",function(){
